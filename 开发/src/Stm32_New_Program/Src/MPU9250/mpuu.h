...
struct mpu_platform_data {
	__uint8_t int_config;
	__uint8_t level_shifter;
	__s8 orientation[9];
};
...
#define MPU_READ_COMPASS	_IOR(MPU_IOCTL, 0x12, __uint8_t)
#define MPU_READ_ACCEL		_IOR(MPU_IOCTL, 0x13, __uint8_t)
#define MPU_READ_PRESSURE	_IOR(MPU_IOCTL, 0x14, __uint8_t)
...
#define MPU_GET_IRQ_TO_FIFO_DIVIDER	_IOR(MPU_IOCTL, 0x41, __uint16_t)
#define MPU_SET_IRQ_TO_FIFO_DIVIDER	_IOW(MPU_IOCTL, 0x41, __uint16_t)
#define MPU_GET_IGNORE_SYSTEM_SUSPEND	_IOR(MPU_IOCTL, 0x42, __uint8_t)
#define MPU_SET_IGNORE_SYSTEM_SUSPEND	_IOW(MPU_IOCTL, 0x42, __uint8_t)
#define MPU_GET_MLDL_STATUS		_IOR(MPU_IOCTL, 0x43, __uint8_t)
#define MPU_GET_I2C_SLAVES_ENABLED	_IOR(MPU_IOCTL, 0x44, __uint8_t)
